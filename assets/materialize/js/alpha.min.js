$(document).ready(function() {
  ...
  if (1 ===
      $(".material-design-hamburger__icon").length &&
      document.querySelector(".material-design-hamburger__icon")
              .addEventListener("click", function() {
                var e;
                document.body.classList.toggle("background--blur"), this.parentNode.nextElementSibling.classList.toggle(
                  "menu--on"), e = this.childNodes[1].classList, e.contains(
                  "material-design-hamburger__icon--to-arrow") ?
                                                                 (e.remove(
                                                                   "material-design-hamburger__icon--to-arrow"), e.add(
                                                                   "material-design-hamburger__icon--from-arrow")) :
                                                                 (e.remove(
                                                                   "material-design-hamburger__icon--from-arrow"), e.add(
                                                                   "material-design-hamburger__icon--to-arrow"))
      ...
      $("#slide-out").toggle(), $(".mn-inner").toggleClass("hidden-fixed-sidebar"), $(".mn-content")
        .toggleClass("fixed-sidebar-on-hidden"), $(document).trigger("fixedSidebarClick")
    }), $(window).width() <
        993 &&
        !$(".mn-content").hasClass("fixed-sidebar-on-hidden") &&
        ($(".fixed-sidebar .navigation-toggle a").click(), $(
          ".fixed-sidebar .navigation-toggle a span")
    ...
    $(document).mouseup(function(e) {
      var a = $(".search-results"), t = $(".search input#search");
      a.is(e.target) ||
      t.is(e.target) ||
      0 !==
    ...
    $(".search-result-container").fadeOut(1), $(".res-not-found").fadeOut(1), $(
      ".search input#search").on("input", function() {
      $(".search-result-container").fadeOut(1), $(".res-not-found").fadeOut(1), t(function() {
        0 !=
        !$.trim($(".search input#search").val()).length ?
        ($(".search-result-container").fadeOut(1), $(".res-not-found").fadeIn(1)) :
        $(".search-result-container").fadeIn()
      }, 500), $(".search-text").text(this.value)
    })
  }
  $(".sidebar-account-settings:not(.show)").fadeOut(0), $(".account-settings-link")
    .click(function() {
      $(".sidebar-account-settings").hasClass("show") ?
      ($(".sidebar-account-settings").fadeOut(0), $(".sidebar-menu").fadeIn(300), $(
        ".sidebar-account-settings").removeClass("show")) :
      ($(".sidebar-account-settings").fadeIn(300), $(".sidebar-menu").fadeOut(0), $(
        ".sidebar-account-settings").addClass("show"))
    }), $(".dropdown-right").dropdown({ alignment: "right" }), $(
    ".button-collapse:not(.right-sidebar-button)").sideNav(), $(
    ".button-collapse.right-sidebar-button").sideNav({ edge: "right" }), $(".chat-button")
    .sideNav({ edge: "right" }), $(".chat-message-link")
    .sideNav({
      menuWidth: 320,
      edge: "right"
    }), $(".chat-message").click(function() {
    $(".chat-message-link").click()
  }), $(".collapsible").collapsible(), $(".slider").slider({ full_width: !0 }), $(
    ".left-sidebar-hover").mouseover(function() {
    $(".button-collapse").click(), $(".material-design-hamburger__layer")
      ...
      "#slide-out").addClass("openOnHover"), $("#slide-out").mouseleave(function() {
      $(this).hasClass("openOnHover") &&
      ($(".button-collapse").click(), $(".material-design-hamburger__layer")
        .addClass("material-design-hamburger__icon--from-arrow"), $(
        ".material-design-hamburger__layer")
        .removeClass("material-design-hamburger__icon--to-arrow"), $("#slide-out")
        .removeClass("openOnHover"))
    })
  }), $(".modal-trigger").leanModal(), $("select").material_select(), preloader =
    new $.materialPreloader({
      position: "top",
      height: "5px",
      col_1: "#159756",
      col_2: "#da4733",
